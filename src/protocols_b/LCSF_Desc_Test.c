...
const lcsf_validator_protocol_desc_t LCSF_Test_ProtDesc = {.ProtId = LCSF_TEST_PROTOCOL_ID,
    .ProtVer = LCSF_TEST_PROTOCOL_VERSION,
    .pProtDesc = &LCSF_Test_Desc,
    .pFnInterpretMsg = LCSF_Bridge_TestReceive};
