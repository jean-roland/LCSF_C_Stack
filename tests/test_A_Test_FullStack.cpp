...
TEST(A_Test_Fullstack, valid) {
    ...
    RX_FAIL(LCSF_TranscoderReceive(sc1_msg, sizeof(sc1_msg)));
    RX_FAIL(LCSF_TranscoderReceive(cc1_msg, sizeof(cc1_msg)));
    // Test valid cases
    ...
    RX_OK(LCSF_TranscoderReceive(cc5_msg, sizeof(cc5_msg)));
