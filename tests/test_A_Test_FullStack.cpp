 ...
 * @brief Unit test of the whole LCSF stack + Test protocol (A)
...
// *** Private types ***
enum test_id_e {
    TEST_ID_SC1 = 0, // SC1 command test ID
    TEST_ID_SC3, // SC3 command test ID
    TEST_ID_CC1, // CC1 command test id
    TEST_ID_CC3, // CC3 command test id
    TEST_ID_CC4, // CC4 command test id
...
#ifdef LCSF_SMALL
// Error messages
static const uint8_t err_unknown_prot_msg[] = {0xFF, 0x00, 0x00, 0x02, 0x00, 0x01, 0x01, 0x01, 0x01, 0x00};
static const uint8_t err_unknown_cmd_msg[] = {0xFF, 0x00, 0x00, 0x02, 0x00, 0x01, 0x01, 0x01, 0x01, 0x01};
static const uint8_t err_unknown_att_msg[] = {0xFF, 0x00, 0x00, 0x02, 0x00, 0x01, 0x01, 0x01, 0x01, 0x02};
static const uint8_t err_too_many_att_msg[] = {0xFF, 0x00, 0x00, 0x02, 0x00, 0x01, 0x01, 0x01, 0x01, 0x03};
static const uint8_t err_missing_att_msg[] = {0xFF, 0x00, 0x00, 0x02, 0x00, 0x01, 0x01, 0x01, 0x01, 0x04};
static const uint8_t err_wrong_data_type_msg[] = {0xFF, 0x00, 0x00, 0x02, 0x00, 0x01, 0x01, 0x01, 0x01, 0x05};
static const uint8_t err_bad_prot_ver_msg[] = {0xFF, 0x00, 0x00, 0x02, 0x00, 0x01, 0x01, 0x01, 0x01, 0x06};
// Wrong messages
static const uint8_t bad_version_msg[] = {0x55, 0x02, 0x02, 0x00}; // SC3 with a wrong protocol version
static const uint8_t bad_prot_id_msg[] = {0x21, 0x01, 0x00, 0x00};
static const uint8_t bad_cmd_id_msg[] = {0x55, 0x01, 0x4c, 0x00};
static const uint8_t bad_att_id_msg[] = {0x55,
    0x01, 0x03, 0x09, // CC1
    0x00, 0x01, 0x00, // SA1
...
static const uint8_t extra_att_msg[] = {0x55, 0x01, 0x00, 0x01, 0x00, 0x01, 0x00};
static const uint8_t missing_att_msg[] = {0x55,
    0x01, 0x03, 0x05, // CC1
    0x00, 0x01, 0x00, // SA1
    0x01, 0x02, 0x00, 0x00, // SA2
    0x02, 0x04, 0x00, 0x00, 0x00, 0x00, // SA3
...
static const uint8_t bad_data_type_msg[] = {0x55,
    0x01, 0x03, 0x05, // CC1
...
// Test messages
static const uint8_t sc1_msg[] = {0x55, 0x01, 0x00, 0x00};
static const uint8_t sc2_msg[] = {0x55, 0x01, 0x01, 0x00};
static const uint8_t sc3_msg[] = {0x55, 0x01, 0x02, 0x00};
static uint8_t cc1_msg[] = {0x55,
    0x01, 0x03, 0x0c, // CC1
    0x00, 0x01, 0x01, // SA1
...
static uint8_t cc3_msg_rx[] = {0x55,
    0x01, 0x05, 0x0a, // CC3
    0x00, 0x01, 0x00, // SA1
    0x01, 0x02, 0x00, 0x00, // SA2
...
static uint8_t cc3_msg_tx[] = {0x55,
    0x01, 0x05, 0x0a, // CC3
    0x00, 0x01, 0xff, // SA1
    ...
    0x0a, 0x05, 0x02, 0xf2, 0x05, 0x2a, 0x01, // SA11
    0x0b, 0x04, 0xde, 0x8d, 0x67, 0x40, // SA12
    0x0c, 0x08, 0x75, 0x17, 0x22, 0xaa, 0xfd, 0x90, 0x14, 0x40, // SA13
};

static uint8_t cc4_msg[] = {0x55,
    0x01, 0x06, 0x03, // CC4
    0x00, 0x01, 0x12, // SA1
    0x8a, 0x02, // CA1
...
static uint8_t cc6_msg_rx[] = {0x55,
    0x01, 0x08, 0x02, // CC6
...
static uint8_t cc6_msg_tx[] = {0x55,
    0x01, 0x08, 0x02, // CC6
...
#else
// Error messages
static const uint8_t err_unknown_prot_msg[] = {0xFF, 0xFF, 0x00, 0x00, 0x00, 0x00, 0x02, 0x00, 0x00, 0x00, 0x01, 0x00, 0x01, 0x01, 0x00, 0x01, 0x00, 0x00};
static const uint8_t err_unknown_cmd_msg[] = {0xFF, 0xFF, 0x00, 0x00, 0x00, 0x00, 0x02, 0x00, 0x00, 0x00, 0x01, 0x00, 0x01, 0x01, 0x00, 0x01, 0x00, 0x01};
static const uint8_t err_unknown_att_msg[] = {0xFF, 0xFF, 0x00, 0x00, 0x00, 0x00, 0x02, 0x00, 0x00, 0x00, 0x01, 0x00, 0x01, 0x01, 0x00, 0x01, 0x00, 0x02};
static const uint8_t err_too_many_att_msg[] = {0xFF, 0xFF, 0x00, 0x00, 0x00, 0x00, 0x02, 0x00, 0x00, 0x00, 0x01, 0x00, 0x01, 0x01, 0x00, 0x01, 0x00, 0x03};
static const uint8_t err_missing_att_msg[] = {0xFF, 0xFF, 0x00, 0x00, 0x00, 0x00, 0x02, 0x00, 0x00, 0x00, 0x01, 0x00, 0x01, 0x01, 0x00, 0x01, 0x00, 0x04};
static const uint8_t err_wrong_data_type_msg[] = {0xFF, 0xFF, 0x00, 0x00, 0x00, 0x00, 0x02, 0x00, 0x00, 0x00, 0x01, 0x00, 0x01, 0x01, 0x00, 0x01, 0x00, 0x05};
static const uint8_t err_bad_prot_ver_msg[] = {0xFF, 0xFF, 0x00, 0x00, 0x00, 0x00, 0x02, 0x00, 0x00, 0x00, 0x01, 0x00, 0x01, 0x01, 0x00, 0x01, 0x00, 0x06};
// Wrong messages
static const uint8_t bad_version_msg[] = {0x55, 0x00, 0x02, 0x00, 0x02, 0x00, 0x00, 0x00}; // SC3 with a wrong protocol version
static const uint8_t bad_prot_id_msg[] = {0x21, 0x00, 0x01, 0x00, 0x00, 0x00, 0x00, 0x00};
static const uint8_t bad_cmd_id_msg[] = {0x55, 0x00, 0x01, 0x00, 0x4c, 0x00, 0x00, 0x00};
static const uint8_t bad_att_id_msg[] = {0x55, 0x00,
    0x01, 0x00, 0x03, 0x00, 0x09, 0x00, // CC1
...
static const uint8_t extra_att_msg[] = {0x55, 0x00, 0x01, 0x00, 0x00, 0x00, 0x01, 0x00, 0x00, 0x00, 0x01, 0x00, 0x00};
static const uint8_t missing_att_msg[] = {0x55, 0x00,
    0x01, 0x00, 0x03, 0x00, 0x05, 0x00, // CC1
    0x00, 0x00, 0x01, 0x00, 0x00, // SA1
    0x01, 0x00, 0x02, 0x00, 0x00, 0x00, // SA2
    0x02, 0x00, 0x04, 0x00, 0x00, 0x00, 0x00, 0x00, // SA3
    0x03, 0x00, 0x05, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, // SA4
...
static const uint8_t bad_data_type_msg[] = {0x55, 0x00,
    0x01, 0x00, 0x03, 0x00, 0x05, 0x00, // CC1
...
// Test messages
static const uint8_t sc1_msg[] = {0x55, 0x00, 0x01, 0x00, 0x00, 0x00, 0x00, 0x00};
static const uint8_t sc2_msg[] = {0x55, 0x00, 0x01, 0x00, 0x01, 0x00, 0x00, 0x00};
static const uint8_t sc3_msg[] = {0x55, 0x00, 0x01, 0x00, 0x02, 0x00, 0x00, 0x00};
static uint8_t cc1_msg[] = {0x55, 0x00,
    0x01, 0x00, 0x03, 0x00, 0x0c, 0x00, // CC1
...
static uint8_t cc3_msg_rx[] = {0x55, 0x00,
    0x01, 0x00, 0x05, 0x00, 0x0a, 0x00, // CC3
    0x00, 0x00, 0x01, 0x00, 0x00, // SA1
    0x01, 0x00, 0x02, 0x00, 0x00, 0x00, // SA2
...
static uint8_t cc3_msg_tx[] = {0x55, 0x00,
    0x01, 0x00, 0x05, 0x00, 0x0a, 0x00, // CC3
...
static uint8_t cc4_msg[] = {0x55, 0x00,
    0x01, 0x00, 0x06, 0x00, 0x03, 0x00, // CC4
...
static uint8_t cc5_msg[] = {0x55, 0x00,
    0x01, 0x00, 0x07, 0x00, 0x03, 0x00, // CC5
...
static uint8_t cc6_msg_rx[] = {0x55, 0x00,
    0x01, 0x00, 0x08, 0x00, 0x02, 0x00, // CC6
...
static uint8_t cc6_msg_tx[] = {0x55, 0x00,
    0x01, 0x00, 0x08, 0x00, 0x02, 0x00, // CC6
...
static void test_buffer(int testid, const uint8_t *pBuffer) {
    switch (testid) {
        case TEST_ID_SC1:
            LCSF_DBG_PRINT("[tests]: SC1 test.\n");
            MEMCMP_EQUAL(pBuffer, sc1_msg, sizeof(sc1_msg));
        break;
        ...
        case TEST_ID_CC1:
            LCSF_DBG_PRINT("[tests]: CC1 test.\n");
            MEMCMP_EQUAL(pBuffer, cc1_msg, sizeof(cc1_msg));
        break;
        ...
        case TEST_ID_CC4:
            LCSF_DBG_PRINT("[tests]: CC4 test.\n");
            MEMCMP_EQUAL(pBuffer, cc4_msg, sizeof(cc4_msg));
        break;
...
/**
 * testgroup: A_Test_Fullstack
 *
 * This group tests encoding/decoding of the whole LCSF stack + Test protocol (A)
 */
TEST_GROUP(A_Test_Fullstack) {
    void setup() {
        mock().strictOrder();
        // Init modules
        CHECK(LCSF_TranscoderInit());
        CHECK(LCSF_ValidatorInit(&senderr_callback, nullptr));
...
TEST(A_Test_Fullstack, valid) {
    ...
    CHECK_FALSE(LCSF_TranscoderReceive(sc1_msg, sizeof(sc1_msg)));
    CHECK_FALSE(LCSF_TranscoderReceive(cc1_msg, sizeof(cc1_msg)));
    // Test valid cases
    CHECK(LCSF_TranscoderReceive(sc2_msg, sizeof(sc2_msg)));
    test_buffer(TEST_ID_SC1, txbuffer);
    ...
    test_buffer(TEST_ID_CC1, txbuffer);
    CHECK(LCSF_TranscoderReceive(cc3_msg_rx, sizeof(cc3_msg_rx)));
    test_buffer(TEST_ID_CC3, txbuffer);
    CHECK(LCSF_TranscoderReceive(cc5_msg, sizeof(cc5_msg)));
    test_buffer(TEST_ID_CC4, txbuffer);
