...
// Test data
#ifdef LCSF_SMALL
    static const uint8_t ovrflwMsg[] = {0xaa, 0x01, 0x01, 0x20};
    static const uint8_t badformatMsg[] = {0xaa, 0x01, 0x01, 0x0a};
    static const uint8_t rxMsg[] = {
        0xab, 0x01, // ProtId, ProtVer
        0x12, 0x03, 0x55, 0x05, 0x00, 0x01, 0x02, 0x03, 0x04,
...
#else
    static const uint8_t ovrflwMsg[] = {0xaa, 0x00, 0x01, 0x00, 0x01, 0x00, 0x20, 0x00};
    static const uint8_t badformatMsg[] = {0xaa, 0x00, 0x01, 0x00, 0x01, 0x00, 0x0a, 0x00};
    static const uint8_t rxMsg[] = {
        0xab, 0x00, 0x01, 0x00, // ProtId, ProtVer
        0x00, 0x12, 0x03, 0x00, 0x55, 0x00, 0x05, 0x00, 0x00, 0x01, 0x02, 0x03, 0x04,
...
TEST(LCSF_Transcoder, encode) {
    ...
    CHECK_EQUAL(LCSF_TranscoderEncode(&txMsg, txBuffer, TX_BUFF_SIZE), 40);
#else
    LCSF_DBG_PRINT("[tests]: Regular LCSF representation is in use.\n");
    CHECK_EQUAL(LCSF_TranscoderEncode(&txMsg, txBuffer, TX_BUFF_SIZE), 56);
#endif
